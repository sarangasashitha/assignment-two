...
public class Aardvark {
  ...
  private Domino findDominoAt(int x, int y) {
    for (Domino d : _d) {
    	final boolean n = (d.lx == x && d.ly == y);
    	final boolean m = (d.hx == x && d.hy == y);
       if (n||m){
        return d;
      }
    }
      ...
      case 1: {
        ...
        while (c3 != ZERO) {
          ...
          case 7:
            ...
            break;
          case 6:
        	 final double particularDomino = 500;
            ...
            System.out.println(u8);
            System.out.println("1) Find a particular Domino (costs you "+particularDomino+")");
            System.out.println("2) Which domino is at ... (costs you "+Domino+")");
            System.out.println("3) Find all certainties (costs you "+Certainties+")");
            System.out.println("4) Find all possibilities (costs you "+Possibilities+")");
...
//                score++;
  ...
  private void printGameOptions(String playerName) {
	  System.out.println();
      String h5 = "Play menu";
...
private void printDifficultyMenuItems() {
	  System.out.println();
